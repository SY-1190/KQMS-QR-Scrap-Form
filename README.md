...
운영 QR은 특정 공정을 고정하지 않습니다. 발생 공정, 작성 팀/부서, 폐기품 적치 위치와 위치 사진, 폐기제품 공정진행사항, 품번 통합검색은 접수권이 있는 동안에만 운영 중계 서비스를 통해 조회할 수 있습니다. 품번 검색은 운영 기준정보의 실제 품번·품명·모델·고객사·등록 고객사 별칭을 대상으로 최대 20건을 제공합니다. 제출 후에는 비밀 확인키로 전송 대기부터 KQMS 완료 또는 실패까지의 상태를 확인합니다.
